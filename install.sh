...
mkdir -p $HOME/UOC/Object-Oriented\ \Programming 
...
[ ! -d $HOME/UOC/Object-Oriented\ Programming/OOP-Practices ] && cd $HOME/UOC/Object-Oriented\ Programming && git clone https://gitlab.com/madebypixel02/OOP-Practices.git && cd $HOME
